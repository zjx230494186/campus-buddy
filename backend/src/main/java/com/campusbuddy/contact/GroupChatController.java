...
public class GroupChatController {
    ...
    @GetMapping(value = "/api/me/group-chats", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/api/me/group-chats/{groupChatId}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(
            value = "/api/me/group-chats/{groupChatId}",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE
    )
    ...
    @DeleteMapping(value = "/api/me/group-chats/{groupChatId}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(
            value = "/api/me/group-chats/{groupChatId}/messages",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE
    )
    ...
    @GetMapping(value = "/api/me/group-chats/{groupChatId}/messages", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/api/me/group-chats/{groupChatId}/read", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(
            value = "/api/me/group-chats/{groupChatId}/members",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE
    )
    ...
    @DeleteMapping(value = "/api/me/group-chats/{groupChatId}/members/{userId}", produces = MediaType.APPLICATION_JSON_VALUE)
